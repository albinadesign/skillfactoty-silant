...
Админ панель по адресу http://localhost:8000/admin/  логин admin пароль admin
...
Зайдем от лица менеджера, которому доступна вся информация. Наиболее полная таблица на всех вкладках, есть фильтры, данные сортированы по датам
